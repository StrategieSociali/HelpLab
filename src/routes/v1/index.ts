...
import { sponsorshipRequestsRoutes } from './sponsorshipRequests.js'
import { roleRequestsRoutes }        from './roleRequests.js'
...
export async function v1Routes(app: FastifyInstance) {
  ...
  await app.register(sponsorshipRequestsRoutes)
  await app.register(roleRequestsRoutes)
}
