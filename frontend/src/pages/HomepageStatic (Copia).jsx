      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <p>
              Sei un'impresa? Trasforma il tuo impegno ESG in azioni concrete e misurabili.
            </p>
            <p>
              Sei un cittadino? Aiutaci a creare la più grande community sostenibile d'Italia. Insieme possiamo creare un impatto positivo duraturo per le generazioni future. Ecco i nostri obiettivi per il 2026:
            </p>
            <p>
              Ecco i nostri obiettivi per il 2026:
            </p>
            <div className="hero-stats">
              ...
              <div className="stat">
                ...
                <div className="stat-text">
                  ...
                  <div className="stat-label">Alberi equivalenti</div>
                </div>
              </div>
            </div>
